  ...
  return (
    <Card className="overflow-hidden p-0">
      <div className="flex items-center justify-between px-5 pt-4 pb-3">
        ...
        <Link
          href={`/radar?lat=${location.latitude}&lon=${location.longitude}`}
      ...
      <Link href={`/radar?lat=${location.latitude}&lon=${location.longitude}`} className="group relative block h-56 w-full bg-slate-100 dark:bg-slate-800">
